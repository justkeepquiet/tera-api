...
function DebugEnable() {
	var frame= $('<div/>', {
		'id': 'DebugArea',
		'style': 'display: block; width: 99%; height: 125px; overflow: auto; padding: 0 10px;'
	});
	var contents= $('<div/>', {
		'id': 'DebugConsole',
		'style': 'font-family: "lucida console", Courier; display: inline; font-size: 10px;'
	});
